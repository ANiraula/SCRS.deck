...
pw.32.p <- round(as.numeric((pw.32/pw.20-1))*100,1)
...
Only **$`r pw.20`K** is what new Age `r entry` (Class Three) SCRS members will accrue after 28 years on the job (value of future benefits at retirement) .
