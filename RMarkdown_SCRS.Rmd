...
### Current Contributions Are Actuarially Insufficient (2021-2051) w/ R (linePlot())
...
urlfile <- "https://raw.githubusercontent.com/ANiraula/SCRS_FModel/main/SCRS.FModel_ERC_Statutory.csv"
stress <- data.frame(
...
data <- as.data.table(data)
  ...
  ggplot2::ggplot(graph, ggplot2::aes(x = year, y = yaxisScale * 
    ...
    ggplot2::scale_colour_manual(values = lineColors) + 
    scale_linetype_manual(values=c("solid", "dashed",  "solid", "dashed"))+#Assigns line types set to each line
    ggplot2::scale_y_continuous(breaks = seq(yaxisMin, if (!is.null(yaxisMax)) {
      yaxisMax
    }
    else {
...
crises <- linePlot(DPF.data, title = NULL, caption = FALSE, grid = FALSE, 
                  ...
                  lab3 = "2022-25 Crisis & 6% Returns",
                  lab5 = "2022-25 Crisis & 2037-40 Crisis & 6% Returns")
                 

crises
```

### SCRS Solvency Degrades Under Crisis Scenarios (2021-2051) w/ R (linePlot())
...
fr.crises <- linePlot(DPF.data, title = NULL, caption = FALSE, grid = FALSE, 
                  ...
                  lab3 = "2022-25 Crisis & 6% Returns (Statutory)",
                  lab5 = "2022-25 Crisis & 2037-40 Crisis & 6% Returns (Statutory)")
...
Value of accrued benefits jumps to **$`r pw.32`K** (or by **`r pw.32.p`%**) just after 4 more years (Age **Age`r age`**, long enough to receive Unreduced/Full benefits)
...
-   And backloads benefits to the point that only few long-career employees will benefit from (and collect), while younger workers often don't.
