---
title: "SCRS Solvency Analysis"
author: "Prepared by: Anil, Swaroop, Jen & Jordan"
date: "07/14/2021"
output:
...
### SCRS Unfunded Liabilities (2001-2021) w/ R (areaPlot())
...
### Causes of Pension Debt (2002-2020) w/ R (custom Plotly-Image)
...
glPlot <- function(database = FALSE, data = NULL,
 ...
 data <- data %>% dplyr::mutate(measure = dplyr::case_when(.data$y > 
   ...
   # orca(fig, paste0(fileName), width =  7 * 300, height = 4 * 300)}else{fig}
    ...
    #Save Plotly as a Static PNG on a local computer (to reference in rmarkdown later)
    #https://github.com/plotly/orca
    orca(fig, paste0(fileName), width = 780, height = 530)}else{fig}
}
...
#       interactive = TRUE, 
#       fileName = "GainLoss.png",
#       title = "<b>Causes of Arkansas ERS Pension Debt (2002-2020)<b>",
#       caption = FALSE,
#       yaxisScale = 1e-03,
#       yaxisMax = 30, 
#       yaxisTick = 3,
...
The "new normal" for the institutional investing suggests that achieving even a 6% average rate of return is optimistic.
...
3.  As FR waits for the "recover" its unfunded liabilities continue to grow.
...
Probabilities <- c(9,8,7.25,6.5,6,5.5,5)
FundARR <- 0.07
#
...
### ADEC Contribution History (2001-2020) w/ R (barPlot())
...
### Benefit Accrual & Retention for New SCRS Employee w/ R (custom)

```{r pwealth, dpi=400, echo = FALSE, fig.cap = "Source: Pension Integrity Project analysis of SCRS actuarial reports and CAFRs. Illustration is based on plan’s Tier 2, Tier 3, Tier 4 assumptions and a hypothetical analysis of an average member hired at the age of 25", fig.width=8, fig.height=5, fig.align = "center", message=FALSE, warning=FALSE}

SalaryData2 <- read_csv("NDPERS_PWealth.csv")
#View(SalaryData2) 
...
prob1 <- round(SalaryData2$RemainingProb[5],3)
prob2 <- round(SalaryData2$RemainingProb[20],3)
...
### Retention: Only Few of 22 Age New SCRS Hires Receive Benefits
    ...
    -   Only `r prob1*100`% of new SCRS employees will stay for 8 years to vest.

</p>

    -   And only `r prob2*100`% of the same employees will be on the job after 34 years needed to qualify for full retirement
